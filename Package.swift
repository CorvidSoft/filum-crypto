...
let targets: [Target] =
    ...
    : [
        .binaryTarget(
            ...
            url:
                "https://github.com/CorvidSoft/filum-crypto/releases/download/v0.5.0/FilumCryptoFFI.xcframework.zip",
            checksum: "3e19d3ed70f30b2f12699eb12ecd58961044864451856082fda9b25dbad5f224"
        ),
        .target(
            name: "FilumCrypto",
